...
if __name__ == '__main__':
    ...
    ts = [
        {'id': 'langchain', 'name': 'LangChain', 'category': 'AI Agent & Framework'},
        {'id': 'frase', 'name': 'Frase', 'category': 'AI Writing & Content'},
        {'id': 'cognigy', 'name': 'Cognigy', 'category': 'AI Marketing & SEO'},
    ]
